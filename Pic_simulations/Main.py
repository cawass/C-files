...
class SimulationParameters:
    def __init__(self):
        ...
        self.Particle_pos_0_1 = [0.4 * self.Mesh_grid_size * self.Mesh_distance, 0.5 * self.Mesh_grid_size * self.Mesh_distance]
        ...
        self.E_initial = [-1*10**(-8)*0 , 0.1*10**(-8)*0]
