...
molecule_combined, Sim_position_X, Sim_position_Y, Sim_temperature = Functions.simulate(molecule_combined, Potential_field_matrix, Electric_field_matrix, Time_step, N_iterations, Num_particles_1+Num_particles_2)
